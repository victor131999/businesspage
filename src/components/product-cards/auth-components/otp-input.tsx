                    ...
                    return (
                        <div
                            ...
                            style={{
                                width: '40px',
                                height: '40px',
                                transition: `transform 1s cubic-bezier(0.2, 0, 0, 1) ${index * 120}ms, opacity 0.5s ease-out ${index * 120 + 600}ms`,
                                transform: `translateX(${translateX}px) scale(${isCollapsed ? 1 : 1})`,
                                zIndex: isCollapsed ? (length - index + 10) : 0,
                                opacity: isCollapsed && index !== 0 ? 0 : 1,
                        ...
                        >
                            {(status === 'verifying' || isCollapsed) && (
                                ...
                                >
                                    <rect
                                        ...
                                        strokeWidth="2"
                                        strokeDasharray="140"
                                        strokeDashoffset={isCollapsed ? 0 : 140}
                                        strokeLinecap="round"
                                        style={{
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    opacity: isCollapsed && showCheckmark ? 0 : (isCollapsed ? 0.3 : 1),
                                } as CSSProperties}
                                onFocus={(e) => {
                                    if (status !== 'idle') return;
