...
export function StreakScreen({ config, updateConfig }: StreakScreenProps) {
  ...
  const remainingDays =
    config.goalProgress.target - config.goalProgress.current;
        ...
        brand:
          parts[0] === "Juan"
            ...
            : parts[0] === "Only"
              ...
              : parts[0],
        description: parts
          .slice(parts[0] === "Juan" || parts[0] === "Only" ? 2 : 1)
          .join(" "),
      };
    }
        ...
        <div className="relative flex justify-center pt-4">
          <div className="relative h-40 w-72">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #004492 0%, #3B82F6 20%, #10B981 50%, #059669 75%, #047857 100%)",
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(0, 68, 146, 0.9) 0%, rgba(59, 130, 246, 0.8) 25%, rgba(16, 185, 129, 0.9) 60%, rgba(5, 150, 105, 1) 100%)",
                }}
              />
