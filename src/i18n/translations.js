export const translations = {
  en: {
    ...
    "products.identity.title": "Identity",
    "products.identity.sub": "Identity proofing, liveness and document checks to reduce fraud and friction.",
    "products.aml.title": "AML Compliance",
